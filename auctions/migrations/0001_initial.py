# Generated by Django 5.2.3 on 2025-06-28 00:27
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('price', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='listed_item_price', to='auctions.bid')),
                ('watchlist', models.ManyToManyField(blank=True, related_name='watching_listings', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Comments',
